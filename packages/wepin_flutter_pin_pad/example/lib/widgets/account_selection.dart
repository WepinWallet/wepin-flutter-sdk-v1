...
class AccountSelectionScreen extends StatefulWidget {
  final List<IAppAccount> getAccounts;
...
class AccountSelectionScreenState extends State<AccountSelectionScreen> {
  Set<IAppAccount> selectedAccounts = <IAppAccount>{};
  ...
  Widget build(BuildContext context) {
    List<IAppAccount> filteredAccounts = widget.withoutToken == true
    ...
    return PopScope(
      onPopInvoked: (bool didPop) {
        ...
        Navigator.pop(context, <IAppAccount>[]);
      },
      child: Scaffold(
        appBar: AppBar(
        ...
        body: Padding(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              IAppAccount account = filteredAccounts[index];
