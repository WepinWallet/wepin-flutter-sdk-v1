...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_bcrypt/flutter_bcrypt.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/wepin_flutter_login_lib/wepin_flutter_login_lib.framework"
fi
